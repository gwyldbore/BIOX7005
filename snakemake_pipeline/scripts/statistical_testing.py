...
def main():
    ...
    g.set(ylim=(0, 150))
    g.figure.suptitle("Number of mutations required for overall subfamily prediction first change", fontweight='bold')
    ...
    # Adjust the title and labels
    g.set_axis_labels('Method', 'Number of Mutations')
    g.figure.suptitle("Number of mutations for overall subfamily prediction change")
    g.set(ylim=(0, 150))
    g.figure.subplots_adjust(bottom=0.25, top=0.88)

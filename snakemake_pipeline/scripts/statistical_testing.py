...
def main():
    ...
    g.set(ylim=(0, 150))
    plt.title("Number of mutations required before overall prediction changes category for the first time", loc='center')
    ...
    # Adjust the title and labels
    g.set_axis_labels('Method', 'Number of Mutations')
    plt.title("Number of mutations required before overall prediction changes category", loc='center')
    g.set(ylim=(0, 150))
    g.figure.subplots_adjust(bottom=0.25)
